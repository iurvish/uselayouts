...
export default function MorphCollections() {
                ...
                >
                  ...
                  {view === "list" && (
                    <motion.div
                      ...
                      className="absolute -bottom-2 left-[4.5rem] right-0 h-px bg-border/40"
                    />
                  )}
                </motion.div>
              ))}
              ...
              {view === "pack" && (
                ...
                >
                  ...
                  {/* <h3 className="text-2xl font-extrabold text-foreground tracking-tight">
                    {ITEMS.length} Visual Sets
                  </h3>
                  <p className="text-muted-foreground text-sm font-medium">
                    Premium creative assets curated for your next project.
                  </p> */}
                </motion.div>
              )}
            </AnimatePresence>
