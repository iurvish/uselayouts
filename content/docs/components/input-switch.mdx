...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tab value="Code">
    ...
    const InputSwitch = () => {
      ...
      return (
        <div className="bg-muted w-3/12 py-1 flex justify-center items-center rounded-full px-1">
          <motion.button
          ...
          <div className="flex-1 relative">
            {!inputValue && (
              <div className="absolute left-0 top-0 w-full h-full flex items-center pointer-events-none pl-1.5 bg-transparent">
                <AnimatePresence mode="popLayout" initial={false}>
                  <motion.div
                    key={currentConfig.id}
