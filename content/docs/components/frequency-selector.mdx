...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tab value="Code">
    ...
    export default function FrequencySelector() {
      ...
      return (
        <div className="w-full h-full min-h-[400px] bg-background flex justify-center items-center font-medium text-sm">
          <motion.div
            layout
            transition={springTransition}
            className="flex flex-col gap-[6px] shadow-[0px_6px_16px_rgba(0,0,0,0.1)] overflow-hidden rounded-3xl bg-muted p-[6px] max-w-[309px] w-full "
          >
