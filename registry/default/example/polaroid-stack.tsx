...
const fanCards: FanCard[] = [
  {
    ...
    hoverClassName:
      "[@media(hover:hover)_and_(pointer:fine)]:group-hover:[transform:rotate(-54deg)_translate(0px,-8px)]",
  },
  {
    src: "https://images.pexels.com/photos/19259515/pexels-photo-19259515.jpeg",
    alt: "Editorial portrait card",
    hoverClassName:
      "[@media(hover:hover)_and_(pointer:fine)]:group-hover:[transform:rotate(-36deg)_translate(0px,-8px)]",
  },
  {
    src: "https://images.pexels.com/photos/8765790/pexels-photo-8765790.jpeg",
    alt: "Lifestyle portrait card",
    hoverClassName:
      "[@media(hover:hover)_and_(pointer:fine)]:group-hover:[transform:rotate(-18deg)_translate(0px,-8px)]",
  },
  {
    src: "https://images.pexels.com/photos/16611954/pexels-photo-16611954.jpeg",
    alt: "Center portrait card",
    hoverClassName:
      "[@media(hover:hover)_and_(pointer:fine)]:group-hover:[transform:rotate(0deg)_translate(0px,-8px)]",
  },
  {
